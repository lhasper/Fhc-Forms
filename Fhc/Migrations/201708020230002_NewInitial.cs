namespace Fhc.Migrations
{
    ...
    public partial class NewInitial : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        FullTimeEmployeeId = c.Int(nullable: false),
                        UserName = c.String(),
                        Password = c.String(),
                        Domain = c.Boolean(nullable: false),
                        Epic = c.Boolean(nullable: false),
                        Dentrix = c.Boolean(nullable: false),
                        Email = c.Boolean(nullable: false),
                        Internet = c.Boolean(nullable: false),
                        Skype = c.Boolean(nullable: false),
                        PhoneExt = c.Boolean(nullable: false),
                        Laptop = c.Boolean(nullable: false),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Buildings", t => t.BuildingId, cascadeDelete: true)
                .ForeignKey("dbo.Departments", t => t.DepartmentId, cascadeDelete: true)
                .ForeignKey("dbo.FullTimeEmployees", t => t.FullTimeEmployeeId, cascadeDelete: true)
                .Index(t => t.DepartmentId)
                .Index(t => t.BuildingId)
                .Index(t => t.FullTimeEmployeeId);
            
            CreateTable(
                "dbo.FullTimeEmployees",
                c => new
                    {
                        FullTimeEmployeeId = c.Int(nullable: false, identity: true),
                    })
                .PrimaryKey(t => t.FullTimeEmployeeId);
        ...
        public override void Down()
        {
            ...
            DropTable("dbo.FullTimeEmployees");
